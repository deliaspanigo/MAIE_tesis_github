...
def run_action(
    ...
    try:
        ...
        json_file_path = generate_plan_download_json_file_path(sat_id=sat_id, product_id=product_id, year=year, day=day)
        ...
        dict_plan_download_local = load_dict_plan_from_json_file(path_json = str(json_file_path))
        ...
        save_dict_plan_as_json_file(dict_plan = dict_plan_download_local_mod, path_json = str(json_file_path))
