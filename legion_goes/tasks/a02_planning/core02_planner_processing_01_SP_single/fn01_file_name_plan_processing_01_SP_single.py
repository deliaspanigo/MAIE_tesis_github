# =============================================================================
# FILE PATH: .../a02_planning/core02_planner_processing/fn01_file_name_plan_processing_01_SP_single.py
...
try:
    ...
    print("\n" + "!"*80)
    print(f" [Planning - Core02 Planner Processing - fn01_file_name_plan_processing_01_SP_single.py]")
...
# 2. CAPA DE PROYECTO (Your Module: legion_goes)
try:
    from legion_goes.SoT.goes_hardcoded_folders import get_my_path
    from legion_goes.SoT.goes_sat import get_satellite_info, AVAILABLE_GOES_SAT_POSITIONS
    ...
    print(f" [PROJECT LIB ERROR] - Internal module 'legion_goes' not found: {e}")
    print("="*80)
...
def get_plan_processing_core01_single_file_name(year: str, day: str, sat_id: str, sat_position: str, product_id: str) -> str:
    """Generates consistent filename for download plans."""
    ctx = "[Planning - get_plan_processing_core01_single_file_name()]"
    ...
    try:
        ...
        return f"plan_02_processing-01-SP-single_{year}_{day_str}_{sat_display_name}_{sat_position}_{product_id}.json"

    except (ValueError, KeyError) as e:
        raise ValueError(f"\n[CRITICAL]{ctx}: {e}\n") from None
        

def get_plan_processing_core01_single_file_path(year: str, day: str, sat_id: str, sat_position: str, product_id: str) -> Path:
    """Returns the full absolute path and ensures directory exists."""
    ctx = "[Planning - get_plan_processing_core01_single_file_path()]"
