"""
Path: legion_goes/code/python_sp/f02_processing/sp001_single/f01_product_proc/ABI_L2_LSTF/fnp01/fn01_python_code.py
...
if __name__ == "__main__":
    ...
    if not nc_candidates:
        ...
        # Ejecutar
        fnp_python_code(nc_path=str(target_nc), **test_paths)
        print("-" * 80 + "\n✅ TEST FINALIZADO\n" + "=" * 80)
