"""
Path: legion_goes/code/python_sp/sp001_single/ABI_L2_MCMIPF/fnp01/fn01_python_code.py
Version: 1.8.5
...
if __name__ == "__main__":
    ...
    # 1. Localizar archivo NC de prueba en la carpeta actual
    try:
        current_dir = Path(__file__).parent.resolve()
    except NameError:
        current_dir = Path(os.getcwd()).resolve()

    nc_candidates = list(current_dir.glob("*.nc"))
