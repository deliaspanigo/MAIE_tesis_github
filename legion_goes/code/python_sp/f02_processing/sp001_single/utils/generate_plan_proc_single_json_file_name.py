# =============================================================================
# FILE PATH: legion_goes/code/python_sp/f01_donwload/utils/generate_plan_proc_single_json_file_name.py
...
def generate_plan_proc_single_json_file_name(sat_id: str, product_id: str, year: str, day: str, fnp_tag: str) -> str:
    """
    Generates standardized filename for Task 03 processing plans.
    Template: plan_02-proc-01-single_[YEAR]_[DAY]_[SAT]_[POS]_[PROD]_[FNP].json
    """
    ctx = "[fn01 - generate_plan_proc_single_file_name]"
    template = "plan_02-proc-01-single_[YEAR]-[DAY]_[SAT]-[POS]_[PROD]_[FNP].json"
...
if __name__ == "__main__":
    test_name = generate_plan_proc_single_json_file_name(
        sat_id="19", 
