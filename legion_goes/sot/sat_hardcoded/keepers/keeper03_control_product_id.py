# =============================================================================
# FILE PATH: legion_goes/sot/sat_hardcoded/keepers/keeper03_control_product_id.py
...
# -------------------------------------------------------------------
try:
    from legion_goes.sot.sat_hardcoded.core.goes_info_product import AVAILABLE_GOES_PRODUCTS
except ImportError as e:
