# =============================================================================
# FILE PATH: legion_goes/sot/sat_hardcoded/keepers/keeper02_control_position.py
...
# -------------------------------------------------------------------
try:
    from legion_goes.sot.sat_hardcoded.core.goes_info_sat import AVAILABLE_GOES_POSITIONS
except ImportError as e:
    ...
    print(" Check if 'goes_info_sat.py' exists in sat_hardcoded/core/ and is importable.")
