# =============================================================================
# FILE PATH: legion_goes/sot/sat_hardcoded/keepers/keeper01_control_sat_id.py
...
# -------------------------------------------------------------------
try:
    from legion_goes.sot.sat_hardcoded.core.goes_info_sat import AVAILABLE_GOES_ID
except ImportError as e:
