# =============================================================================
# FILE PATH: legion_goes/sot/sat_hardcoded/access/get_SOT_define_position.py
...
try:
    from legion_goes.sot.sat_hardcoded.core.goes_info_sat import SAVED_INFO_SAT_GOES
except ImportError as e:
    print("\n" + "="*80)
    print(f" [CRITICAL ERROR] - [ACCESS - get_SOT_define_position.py]")
    print("="*80)
    print(f" Failed to load SoT data from core: {e}")
    print(" Ensure 'goes_info_sat.py' exists in sat_hardcoded/core/.")
    print("="*80 + "\n")
    raise SystemExit(1)
