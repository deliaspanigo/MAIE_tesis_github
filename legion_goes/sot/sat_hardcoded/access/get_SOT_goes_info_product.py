# =============================================================================
# FILE PATH: legion_goes/sot/sat_hardcoded/access/get_SOT_goes_info_product.py
...
try:
    from legion_goes.sot.sat_hardcoded.core.goes_info_product import (
        SAVED_INFO_PROD_GOES,
        AVAILABLE_GOES_PRODUCTS
    )
    from legion_goes.sot.sat_hardcoded.keepers.keeper03_control_product_id import control_product_id
    ...
    print(" Check if 'goes_info_product.py' exists in sat_hardcoded/core/.")
