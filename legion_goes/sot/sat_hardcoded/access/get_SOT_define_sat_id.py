# =============================================================================
# FILE PATH: legion_goes/sot/sat_hardcoded/access/get_SOT_define_sat_id.py
...
# -------------------------------------------------------------------
try:
    from legion_goes.sot.sat_hardcoded.keepers.keeper02_control_position import control_position
    from legion_goes.sot.sat_hardcoded.keepers.keeper04_control_year import control_year
    from legion_goes.sot.sat_hardcoded.keepers.keeper05_control_day import control_day
    from legion_goes.sot.sat_hardcoded.keepers.keeper01_control_sat_id import control_sat_id
