"""
Path: src/goes_processor/task/task03_processing/subtask01_proc_single/actions/action01_gen_plan_proc_single.py
Version: 1.5.0
...
from goes_processor.task.task02_download.actions.action01_gen_plan_download import get_dict_plan_download
...
def gen_and_save_plan_proc_single(year: int, day: int, sat_pos: str, product_id: str, 
    ...
    print(f"🎯 [SUCCESS] Plan v.1.5.0 saved.")
