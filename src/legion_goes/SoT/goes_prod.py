# =============================================================================
# FILE PATH: src/legion_goes/SoT/goes_prod.py
...
def get_product_info(product_id: str) -> MappingProxyType:
    """Returns the full metadata dictionary for a specific GOES product."""
    ctx = "[CRITICAL - goes_prod.py - get_product_info()]"
    try:
        if product_id not in SAVED_INFO_PROD_GOES:
            raise KeyError(f"Product ID '{product_id}' not found. Available: {AVAILABLE_GOES_PRODUCTS}")
