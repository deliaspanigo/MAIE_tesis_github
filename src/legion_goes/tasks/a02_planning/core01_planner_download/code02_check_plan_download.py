"""
Path: src/legion_goes/actions/a02_planning/core01_planner_download/code02_check_plan_download.py
...
try:
    ...
    from legion_goes.SoT.goes_sat import get_goes_id_by_julian_date
