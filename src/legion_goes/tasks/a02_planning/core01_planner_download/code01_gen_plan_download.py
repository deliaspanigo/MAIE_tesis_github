"""
Path: src/legion_goes/actions/a02_planning/core01_planner_download/code01_gen_plan_download.py
...
try:
    ...
    from legion_goes.SoT.goes_sat import get_goes_id_by_julian_date, get_satellite_info, AVAILABLE_GOES_SAT_POSITIONS
    from legion_goes.SoT.goes_prod import SAVED_INFO_PROD_GOES, AVAILABLE_GOES_PRODUCTS
